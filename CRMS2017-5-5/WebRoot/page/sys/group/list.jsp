...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabForm">
  ...
  <tr>
  <td>
<s:form name="form1" method="post" action="GroupAction_list.do" namespace="/sys">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" name="base" id="base">
		<tr>
			...
			<div class="control"align="center">
			  部门搜索：<s:textfield name="name" id="name"  cssStyle="width:140px"/>
			  <button type='button' class='button' onMouseOver="this.className='button_over';" 
			                                     onMouseOut="this.className='button';"  onClick="document.forms[0].submit()"> <img src="${pageContext.request.contextPath}/ui/images/button/sousuo.png" border='0' align='absmiddle'>&nbsp;搜索</button>
              <button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  
			        onClick="forward('group.do?method=search')"> <img src="${pageContext.request.contextPath}/ui/images/button/qingkong.png" border='0' align='absmiddle'>&nbsp;清空</button>
			</div>
			</td>
		</tr>
	</table>
...
<br>
<h3 align="center"><img src="${pageContext.request.contextPath}/ui/images/menu/khlb.png" border="0">&nbsp;部门列表</h3>&nbsp;&nbsp;&nbsp;
<!-- list -->
<div >

<s:form name="form2" method="post" action="GroupAction_delete.do" namespace="/sys">
<table align="center" width="80%" border="0" cellspacing="0" cellpadding="0" id="PowerTable" class="PowerTable">
	<!-- title -->
	<tr>
	...
	<s:if test="%{#request.sysUserGroups!=null}">
	  <s:iterator value="%{#request.sysUserGroups}" var="sysUserGroup"> 
	    	...
	    	<td>
	  	    ...
	  	    <td><a href="${pageContext.request.contextPath}/sys/GroupAction_edit.do?id=<s:property value="%{#sysUserGroup.id}"/>"><s:property value="%{#sysUserGroup.name}"/></a></td>
	...
	<table width="100%" border="0" class="">
		    ...
		    <tr>
		      <td><div align="right">
		        <div class="control">
		          <button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  
	        onClick="forward('${pageContext.request.contextPath}/sys/GroupAction_add.do')"> <img src="${pageContext.request.contextPath}/ui/images/button/xinjian.png" border='0' align='absmiddle'>&nbsp&nbsp;新建</button>
		          </div>
		      </div></td>
		      <td>&nbsp;</td>
		      <td><div>
		        <button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  
	        onClick="document.forms[1].submit();"> <img src="${pageContext.request.contextPath}/ui/images/button/shanchu.png" border='0' align='absmiddle'>&nbsp&nbsp;删除</button>
	          </div></td>
	        </tr>
	      </table>
</s:form>
