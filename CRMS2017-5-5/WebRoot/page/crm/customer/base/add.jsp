...
<s:form name="companyForm" method="post" action="/company_save.do" namespace="/com">
<div class="mtitle">
...
<div class="control">
	...
	<button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  onClick="name2pinyin();">
  	...
  	<td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td width="34%"> 
			  <!--<s:textfield id="names" name="names" value=""  cssStyle="width:90%" onblur="alert('123')" /> 离开焦点 -->
			  <button onclick="alert('jkl')" value="点击"></button>
			</td>
		  </tr>
		  <tr>
			<td>拼音码：</td>
