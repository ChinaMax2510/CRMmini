...
<script type="text/javascript">
	...
	function goSet(){
		var id=$("#id").val();
		var url = "${pageContext.request.contextPath}/com/Company_shoeShareOne.do?id="+id;
...
<body>
<s:form name="ActionForm" method="post" action="Company_ShareCancel.do" namespace="/com">
...
选择模块：
  ...
  &nbsp;
  <div><input type='checkbox' class='checkbox' name='s_module' value='c_tell' id='c_company'>客户联系方式</div>
</fieldset>
</div>
<br>
</s:form>
