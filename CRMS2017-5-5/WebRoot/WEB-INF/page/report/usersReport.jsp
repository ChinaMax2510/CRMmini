...
<div class="tab-pane" id="tabPane1">
	<div class="tab-page" id="tabPage1">
		<h2 class="tab">报表图形</h2>
			<a href="#" target="_blank">
				<img src="${pageContext.request.contextPath}/temp/${filename}" border="1">
			</a>
	</div>
	...
	<div class="tab-page" id="tabPage2">
        ...
        <div id="report">
	        <div class="reportTitle">用户分类分析报表</div>
	             <table width="97%" border="1" cellspacing="0" cellpadding="0" class="reportTable">
						<tr>
							<td width="30%" class="thead">用户名</td>
							<td width="31%" class="thead">人数</td>
