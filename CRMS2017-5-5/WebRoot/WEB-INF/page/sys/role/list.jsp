...
function setPopedom(id) {
	OpenWin('${pageContext.request.contextPath}/sys/sysRoleAction_ListPopdeom.do?roleId='+id,'',800,600);
}
function setMenu(id) {
...
<div class="control">
	<button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  
	         onClick="forward('${pageContext.request.contextPath}/sys/sysRoleAction_ToAdd.do')">
          ...
          <s:iterator value="%{#request.rolelist}" var="sysRole"> 
			<tr> 
		    	<td>
		  	    ...
		  	    <td><a href="${pageContext.request.contextPath}/sys/sysRoleAction_ToEdit.do?id=<s:property value="%{#sysRole.id}"/>">
